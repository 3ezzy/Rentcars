...
<main class="sm:ml-64 p-4">
    <div class="flex flex-wrap items-center justify-between mb-4">
        <h1 class="flex items-center gap-2 text-xl sm:text-3xl font-extrabold text-blue-600">
            <i class="fa-regular fa-user text-xl sm:text-3xl"></i>
            <span>List of Users</span>
        </h1>
        <a href="createUser.php" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-xs sm:text-sm px-3 sm:px-5 py-2 sm:py-2.5 text-center">
            Add User
        </a>
    </div>
                        ...
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="px-2 py-2 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex flex-wrap items-center space-x-2">
                                    ...
                                    <a href="deleteClient.php?NumClient=<?= $row['NumClient'] ?>" onclick="return confirm('Are you sure you want to delete <?= $row['Nom'] ?>?')"
