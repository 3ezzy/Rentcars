...
<body>
    ...
    <div class="relative min-h-screen">
        ...
        <div class="flex items-center justify-between mb-4">
                ...
                <a href="createContract.php" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    Add Contract
                </a>
            </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md table-auto">
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            ?>
                            <tr>
                                <td colspan="7" class="text-center text-gray-500">Aucun Contrats trouvé.</td>
                            </tr>
                        <?php
                    }
                        ?>
