...
<body>
    ...
    <div class="relative min-h-screen">
        ...
        <div class="flex items-center justify-between mb-4">
                    <h1 class="flex items-center gap-2 text-3xl font-extrabold text-blue-600">
                        <i class="fa-solid fa-car text-3xl"></i>
                        <span>List of Cars</span>
                    </h1>
                    <a href="createCars.php" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        Add car
                    </a>
                </div>
